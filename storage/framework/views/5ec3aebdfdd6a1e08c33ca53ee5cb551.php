...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Owner Dashboard'); ?> | Eserian Homes</title>
...
<?php echo $__env->make('layouts.partials.owner-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div id="main-wrapper" class="flex flex-col min-h-screen">
    ...
    <?php echo $__env->make('layouts.partials.footer-owner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<?php /**PATH C:\xampp\htdocs\eserian-homes\resources\views/layouts/owner.blade.php ENDPATH**/ ?>