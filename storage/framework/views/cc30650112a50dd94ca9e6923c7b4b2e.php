...
<div class="container-custom">
    ...
    <div class="mb-8">
        <h1 class="text-3xl md:text-4xl font-bold text-text-primary heading-font mb-2">
            Welcome back, <?php echo e(is_object($user) ? ($user->name ?? 'Guest') : (is_array($user) ? ($user['name'] ?? 'Guest') : 'Guest')); ?>! 👋
        </h1>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-10">
        <div class="bg-surface-card rounded-xl p-4 md:p-5 shadow-sm border border-border-color hover-lift">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="text-2xl md:text-3xl font-bold text-text-primary"><?php echo e($totalBookings ?? 0); ?></span>
            </div>
        ...
        <div class="bg-surface-card rounded-xl p-4 md:p-5 shadow-sm border border-border-color hover-lift">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="text-2xl md:text-3xl font-bold text-text-primary"><?php echo e($upcomingBookings ?? 0); ?></span>
            </div>
        ...
        <div class="bg-surface-card rounded-xl p-4 md:p-5 shadow-sm border border-border-color hover-lift">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="text-2xl md:text-3xl font-bold text-text-primary">KES <?php echo e(number_format($totalSpent ?? 0, 0)); ?></span>
            </div>
        ...
        <div class="bg-surface-card rounded-xl p-4 md:p-5 shadow-sm border border-border-color hover-lift">
            <div class="flex items-center justify-between mb-3">
                ...
                <span class="text-2xl md:text-3xl font-bold text-text-primary"><?php echo e($favoriteCount ?? 0); ?></span>
            </div>
    ...
    <div class="mb-10">
        <div class="flex justify-between items-center mb-5">
            ...
            <a href="<?php echo e(route('customer.bookings')); ?>" class="text-brand-600 text-sm font-semibold hover:underline flex items-center gap-1">
                View all
            ...
            <div class="space-y-3">
                ...
                <div class="bg-surface-card rounded-xl p-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-sm border border-border-color hover-lift">
                    <div class="flex items-center gap-4">
                        ...
                        ?>
                        <?php if($photoPath): ?>
                            <img src="<?php echo e(asset('storage/' . $photoPath)); ?>" alt="<?php echo e($booking->property->title ?? 'Property'); ?>" class="w-16 h-16 rounded-lg object-cover">
                        <?php else: ?>
                        ...
                        <?php endif; ?>
                        <div>
                            <h3 class="font-semibold text-text-primary"><?php echo e($booking->property->title ?? 'Property'); ?></h3>
                            <p class="text-sm text-text-muted"><?php echo e($booking->property->location ?? 'Unknown'); ?></p>
                            <p class="text-xs text-text-muted mt-1">
                                <?php echo e(\Carbon\Carbon::parse($booking->check_in_date)->format('M d, Y')); ?> - <?php echo e(\Carbon\Carbon::parse($booking->check_out_date)->format('M d, Y')); ?>

                            </p>
                        </div>
                    </div>
                    <div class="text-left md:text-right">
                        <p class="font-bold text-text-primary">KES <?php echo e(number_format($booking->total_price ?? 0)); ?></p>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            <a href="<?php echo e(route('customer.browse')); ?>" class="bg-surface-card rounded-xl p-6 text-center shadow-sm border border-border-color hover-lift group">
            ...
            <a href="<?php echo e(route('customer.bookings')); ?>" class="bg-surface-card rounded-xl p-6 text-center shadow-sm border border-border-color hover-lift group">
            ...
            <a href="<?php echo e(route('customer.saved')); ?>" class="bg-surface-card rounded-xl p-6 text-center shadow-sm border border-border-color hover-lift group">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\eserian-homes\resources\views/customer/dashboard.blade.php ENDPATH**/ ?>