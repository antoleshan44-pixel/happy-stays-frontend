    ...
    <div class="owner-footer-inner">
        ...
        <div class="owner-footer-grid">
            ...
            <div class="owner-footer-col">
                ...
                <ul class="footer-link-list">
                    <li><a href="<?php echo e(route('owner.dashboard')); ?>" class="footer-link">Dashboard</a></li>
                    <li><a href="<?php echo e(route('owner.properties')); ?>" class="footer-link">My Properties</a></li>
                    <li><a href="<?php echo e(route('owner.earnings')); ?>" class="footer-link">Earnings</a></li>
                    <li><a href="<?php echo e(route('owner.property.create')); ?>" class="footer-link">List a Property</a></li>
                    <li><a href="<?php echo e(route('customer.browse')); ?>" class="footer-link">Explore Listings</a></li>
                </ul>
            </div>
        ...
        <div class="owner-footer-bottom">
            <span class="footer-copyright">
                © <?php echo e(date('Y')); ?> Eserian Homes Ltd. All rights reserved.
            </span>
...
<?php /**PATH C:\xampp\htdocs\eserian-homes\resources\views/layouts/partials/footer-owner.blade.php ENDPATH**/ ?>