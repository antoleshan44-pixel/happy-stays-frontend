...
<nav class="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl shadow-sm">
    <div class="flex justify-between items-center px-8 py-4 max-w-7xl mx-auto">
        ...
        <div class="hidden md:flex items-center space-x-12">
            <a class="font-manrope tracking-tight font-semibold text-slate-500 hover:text-blue-700 transition-colors" href="<?php echo e(route('customer.browse')); ?>">Collections</a>
            <a class="font-manrope tracking-tight font-semibold text-slate-500 hover:text-blue-700 transition-colors" href="<?php echo e(route('register')); ?>?role=owner">List Property</a>
            <a class="font-manrope tracking-tight font-semibold text-slate-500 hover:text-blue-700 transition-colors" href="<?php echo e(route('customer.browse')); ?>">Concierge</a>
        </div>

        <div class="flex items-center space-x-6">
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('login')); ?>" class="text-slate-500 font-manrope font-semibold hover:text-blue-700 transition-colors">Sign In</a>
                <a href="<?php echo e(route('register')); ?>" class="bg-gradient-to-br from-primary to-primary-container text-on-primary px-6 py-2.5 rounded-md font-manrope font-bold transition-all">Inquire</a>
            <?php else: ?>
                <span class="text-slate-500 font-manrope font-semibold hidden md:inline">Welcome, <?php echo e(Auth::user()->name); ?></span>
                <a href="<?php echo e(Auth::user()->isAdmin() ? route('admin.dashboard') : (Auth::user()->isOwner() ? route('owner.dashboard') : route('customer.dashboard'))); ?>"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-surface-container-lowest rounded-xl p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between py-2 border-b border-outline-variant">
                            ...
                            <span class="font-semibold"><?php echo e($booking->property->title ?? $booking->property['title'] ?? 'Property'); ?></span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-outline-variant">
                            <span class="text-on-surface-variant">Check-in</span>
                            <span class="font-semibold"><?php echo e(\Carbon\Carbon::parse($booking->check_in_date)->format('M d, Y')); ?></span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-outline-variant">
                            <span class="text-on-surface-variant">Check-out</span>
                            <span class="font-semibold"><?php echo e(\Carbon\Carbon::parse($booking->check_out_date)->format('M d, Y')); ?></span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-outline-variant">
                            <span class="text-on-surface-variant">Number of nights</span>
                            <span class="font-semibold"><?php echo e($booking->nights ?? \Carbon\Carbon::parse($booking->check_in_date)->diffInDays(\Carbon\Carbon::parse($booking->check_out_date))); ?> nights</span>
                        </div>
                        <div class="flex justify-between py-2 border-b border-outline-variant">
                            <span class="text-on-surface-variant">Guests</span>
                            <span class="font-semibold"><?php echo e($booking->guests); ?> guests</span>
                        </div>
                        <div class="flex justify-between py-3 mt-2 bg-primary/5 rounded-lg px-3">
                            <span class="font-bold text-lg">Total Amount</span>
                            <span class="font-bold text-2xl text-primary">KES <?php echo e(number_format($booking->total_price ?? $payment->amount ?? 0)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="payment-card">
                <div class="bg-surface-container-lowest rounded-xl p-6">
                    ...
                    <form action="<?php echo e(route('payment.mpesa.process', $booking->id ?? $payment->booking_id)); ?>" method="POST" id="paymentForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-6">
                            <div class="bg-surface-container-high rounded-lg p-4">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <span class="font-bold text-xl text-primary">KES <?php echo e(number_format($booking->total_price ?? $payment->amount ?? 0)); ?></span>
                                </div>
                    ...
                    <div class="mt-6 text-center">
                        <a href="<?php echo e(route('customer.booking.details', $booking->id ?? $payment->booking_id)); ?>" class="text-primary hover:underline text-sm">
...
<?php /**PATH C:\xampp\htdocs\eserian-homes\resources\views/payment/mpesa-payment.blade.php ENDPATH**/ ?>