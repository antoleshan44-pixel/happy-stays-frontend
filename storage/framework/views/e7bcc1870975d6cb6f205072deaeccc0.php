        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: 3rem;">
            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 3rem;"
                ...
                <div>
                    ...
                    <div style="display: flex; gap: 0.75rem; margin-top: 1.5rem;">
                        ...
                        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$href, $svgPath]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($href); ?>" target="_blank" rel="noopener noreferrer" style="
                        ...
                        " onmouseover="this.style.borderColor='#93a8f4';this.style.color='#93a8f4'"
                           onmouseout="this.style.borderColor='rgba(255,255,255,0.12)';this.style.color='#9ca3af'">
                            <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><?php echo $svgPath; ?></svg>
                        </a>
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem;" class="footer-links-grid">
                    ...
                    <div>
                        ...
                        <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.6rem;">
                            <li><a href="<?php echo e(route('customer.help.center')); ?>" class="footer-link">Help Center</a></li>
                            <li><a href="#" class="footer-link">Safety Guidance</a></li>
                            <li><a href="#" class="footer-link">Insurance Policy</a></li>
                            <li><a href="<?php echo e(route('customer.browse')); ?>" class="footer-link">Browse Properties</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        ">Company</p>
                        <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.6rem;">
                            <li><a href="<?php echo e(route('about.us')); ?>" class="footer-link">About Us</a></li>
            ...
            ">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 0.5rem;">
                    <?php $__currentLoopData = ['Nairobi', 'Diani Beach', 'Mombasa', 'Nakuru', 'Nanyuki', 'Naivasha', 'Malindi', 'Amboseli', 'Kisumu', 'Samburu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('customer.browse')); ?>?location=<?php echo e(urlencode($dest)); ?>"
                       style="
...
<?php /**PATH C:\xampp\htdocs\eserian-homes\resources\views/layouts/partials/footer.blade.php ENDPATH**/ ?>