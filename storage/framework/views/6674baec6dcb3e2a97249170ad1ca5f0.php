...
<head>
    ...
    <title>Admin Portal - <?php echo $__env->yieldContent('title'); ?> | Eserian Homes</title>
        ...
        <div class="bg-white border-b border-gray-200 sticky top-0 z-30">
            <div class="px-4 md:px-6 py-3">
                <div class="flex items-center justify-between">
                    ...
                    <!-- Page Title -->
                    <h1 class="text-lg font-semibold text-gray-800 heading-font md:hidden"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
...
<?php /**PATH C:\xampp\htdocs\eserian-homes\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>