...
<div class="container-custom">
    ...
    <div class="wl-header">
        <div class="wl-header__top">
            ...
            <div class="wl-header__count"><?php echo e($properties->count()); ?></div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="wl-grid">
        ...
        ?>
        <div class="wl-card" onclick="window.location.href='<?php echo e(route('customer.property.detail', $property->id)); ?>'">
            <div class="wl-card__img-wrap">
                <img class="wl-card__img"
                     src="<?php echo e($photoPath ? asset('storage/' . $photoPath) : 'https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?w=600&h=450&fit=crop'); ?>"
                     alt="<?php echo e($property->title); ?>"
                     loading="lazy">
                <div class="wl-card__overlay"></div>

                <span class="wl-card__type"><?php echo e($property->property_type ?? 'Property'); ?></span>
                ...
                <button class="wl-card__remove"
                        onclick="event.stopPropagation(); removeFromFavorites(<?php echo e($property->id); ?>)"
            ...
            <div class="wl-card__body">
                <div class="wl-card__name"><?php echo e($property->title); ?></div>
                ...
                <div class="wl-card__price-row">
                    <span class="wl-card__price">KES <?php echo e(number_format($property->price_per_night)); ?></span>
    ...
    <div class="wl-empty">
        ...
        <a href="<?php echo e(route('customer.browse')); ?>" class="wl-empty__cta">
...
function removeFromFavorites(id) {
    ...
    fetch('<?php echo e(url("/customer/property")); ?>/' + id + '/remove', {
        method: 'DELETE',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\eserian-homes\resources\views/customer/wishlist.blade.php ENDPATH**/ ?>