                ...
                <form method="POST" action="<?php echo e(url('/login')); ?>">
                    ...
                    <div class="text-center">
                        <p class="text-xs text-gray-600">
                            ...
                            <a href="<?php echo e(url('/register')); ?>" class="text-primary font-semibold hover:underline">Create Account</a>
                        </p>
                    </div>
                </form>
            </div>
...
<?php /**PATH C:\xampp\htdocs\eserian-homes\resources\views/auth/login.blade.php ENDPATH**/ ?>