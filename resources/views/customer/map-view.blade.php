{{-- resources/views/customer/map-view.blade.php --}}
@extends('layouts.app')
...
<div class="container-custom py-6">
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex gap-3">
            <a href="{{ route('customer.browse') }}" class="px-4 py-2 border border-border-color rounded-lg text-sm font-semibold text-text-primary hover:bg-gray-50 transition">
                List View
            </a>
            <a href="{{ route('customer.map') }}" class="px-4 py-2 bg-brand-500 text-white rounded-lg text-sm font-semibold hover:bg-brand-600 transition">
                Map View
            </a>
        </div>
    </div>
