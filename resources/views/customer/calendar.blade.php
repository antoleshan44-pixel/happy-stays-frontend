{{-- resources/views/customer/calendar.blade.php --}}
@extends('layouts.app')
...
<div class="container-custom">
    ...
    <div class="stats-grid">
        <div class="stat-card stat-card--total">
            ...
            <div class="stat-card__value">{{ $totalBookings ?? 0 }}</div>
            <div class="stat-card__label">Total Bookings</div>
        </div>
        <div class="stat-card stat-card--upcoming">
            <span class="stat-card__icon">✈️</span>
            <div class="stat-card__value">{{ $upcomingCount ?? 0 }}</div>
            <div class="stat-card__label">Upcoming Stays</div>
        </div>
        <div class="stat-card stat-card--completed">
            <span class="stat-card__icon">✅</span>
            <div class="stat-card__value">{{ $completedCount ?? 0 }}</div>
            <div class="stat-card__label">Completed</div>
        </div>
        <div class="stat-card stat-card--nights">
            <span class="stat-card__icon">🌙</span>
            <div class="stat-card__value">{{ $totalNights ?? 0 }}</div>
            <div class="stat-card__label">Total Nights</div>
        </div>
    </div>

    {{-- Two-column layout for calendar + upcoming stays --}}
