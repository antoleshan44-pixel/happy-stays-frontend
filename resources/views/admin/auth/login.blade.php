...
{{-- LOCATION: FRONTEND - Laravel Blade View --}}
            ...
            <form method="POST" action="{{ route('admin.login.post') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                           value="{{ old('email') }}" placeholder="admin@eserian.com" required autofocus>
                    @error('email')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="captcha" class="form-control @error('captcha') is-invalid @enderror mt-2"
