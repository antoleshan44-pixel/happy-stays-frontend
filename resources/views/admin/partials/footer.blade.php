                ...
                <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 1.5rem;" class="admin-footer-links">
                    ...
                    <div>
                        ...
                        <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.5rem;">
                            <li><a href="{{ route('admin.dashboard') }}" class="admin-footer-link">Dashboard</a></li>
                            <li><a href="{{ route('admin.properties') }}" class="admin-footer-link">Properties</a></li>
                            <li><a href="{{ route('admin.users') }}" class="admin-footer-link">Users</a></li>
                            <li><a href="{{ route('admin.payments') }}" class="admin-footer-link">Payments</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        ">Management</p>
                        <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.5rem;">
                            <li><a href="{{ route('admin.pending') }}" class="admin-footer-link">Pending Approvals</a></li>
                            <li><a href="{{ route('admin.fraud.alerts') }}" class="admin-footer-link">Fraud Alerts</a></li>
                            <li><a href="{{ route('admin.disputes') }}" class="admin-footer-link">Disputes</a></li>
                            <li><a href="{{ route('admin.payouts') }}" class="admin-footer-link">Payouts</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        ">Reports</p>
                        <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.5rem;">
                            <li><a href="{{ route('admin.reports') }}" class="admin-footer-link">Analytics</a></li>
                            <li><a href="{{ route('admin.revenue') }}" class="admin-footer-link">Revenue Report</a></li>
                    ...
                    <div>
                        ...
                        ">System</p>
                        <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.5rem;">
                            <li><a href="{{ route('admin.settings') }}" class="admin-footer-link">Settings</a></li>
            ...
            <div style="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 1rem;">
                ...
                <div>
                    <span style="font-size: 0.7rem; color: #4b5563;">
                        <i class="far fa-clock"></i> Server Time: {{ now()->format('Y-m-d H:i:s') }}
                    </span>
                </div>
            </div>
    ...
    <div style="border-top: 1px solid rgba(255,255,255,0.04); background: rgba(0,0,0,0.2);">
        ...
        ">
            <span style="font-size: 0.72rem; color: #4b5563;">
                <i class="far fa-copyright"></i> {{ date('Y') }} Eserian Homes Ltd. All rights reserved.
            </span>
