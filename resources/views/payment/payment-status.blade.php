    ...
    <div class="max-w-2xl w-full">
                ...
                <div class="bg-gray-50 rounded-xl p-6 mb-6 text-left">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold">{{ $payment->booking->property->title }}</span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-xs">{{ $payment->transaction_id ?? 'N/A' }}</span>
                        </div>
                    </div>
                </div>
                
                <div class="flex gap-4">
                    <a href="{{ route('customer.booking.details', $payment->booking->id) }}" 
        ...
        @elseif($payment->status == 'pending')
            <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
                ...
                <div class="flex gap-4">
                    <a href="{{ route('payment.mpesa', $payment->booking->id) }}" 
                       class="flex-1 bg-primary text-white py-3 rounded-md font-semibold hover:bg-primary-container transition-colors">
                        Try Again
                    </a>
