...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These configuration options determine how your Laravel application
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configure which features are enabled in your application.
    |
    */
    ...
    'features' => [
        'reviews' => true,
        'wishlist' => true,
        'referrals' => env('ENABLE_REFERRALS', true),
        'price_alerts' => env('ENABLE_PRICE_ALERTS', true),
    ],
